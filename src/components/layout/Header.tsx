...
import { Search, Bell, ChevronDown, Clapperboard } from "lucide-react";
      ...
      >
        <div className="flex items-center justify-between px-4 py-2.5 sm:py-3 md:px-8 safe-x">
          ...
          <div className="flex items-center gap-3 md:gap-4 ml-auto">
            ...
            <Link
              to="/admin"
              className="hidden sm:flex items-center gap-1.5 border border-gold/30 text-gold text-xs font-bold px-3 py-1.5 rounded-md hover:border-gold/60 hover:bg-gold/10 transition-all"
            >
            ...
            {user ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => signOut()}
                  className="hidden sm:flex text-xs text-text-dim hover:text-gold transition-colors font-semibold px-2 py-1.5"
                >
                  로그아웃
                </button>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="text-xs font-semibold text-text-dim hover:text-gold transition-colors px-2 py-1.5"
                >
                  로그인
                </button>
                <button
                  onClick={() => setAuthMode("signup")}
                  className="text-xs font-bold px-3 py-1.5 rounded-md bg-gradient-gold text-black hover:brightness-110 transition-all"
                >
                  회원가입
                </button>
              </div>
