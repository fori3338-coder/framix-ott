...
export default function Subscription() {
  ...
  return (
    <div className="min-h-screen px-4 md:px-8 pt-20 md:pt-28 pb-16 animate-fade-in flex flex-col items-center">
      ...
      {/* 카드 */}
      <div
        className="w-full max-w-md rounded-2xl border border-gold/30 p-7 md:p-9 relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1 mt-2">
          ...
          <span className="text-sm font-bold text-gold tracking-wide">PREMIUM</span>
        </div>

        {/* 가격 */}
        <div className="mb-6">
          <span className="text-4xl md:text-5xl font-black text-text">4,900</span>
